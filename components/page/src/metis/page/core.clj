...
(defn cont [conf data] (hp/html5 (head/head conf data) (body/default conf data cont/content)))

(defn elem [conf data] (hp/html5 (head/head conf data) (body/default conf data elem/content)))
